...
import entidade.cplus.Perfilusuario;
...
public class PerfilusuarioJpaController implements Serializable {
    ...
    public void create(Perfilusuario perfilusuario) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findPerfilusuario(perfilusuario.getCodperfilusuario()) != null) {
    ...
    public void edit(Perfilusuario perfilusuario) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                String id = perfilusuario.getCodperfilusuario();
    ...
    public void destroy(String id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                perfilusuario.getCodperfilusuario();
    ...
    public Perfilusuario findPerfilusuario(String id) {
        EntityManager em = getEntityManager();
        try {
