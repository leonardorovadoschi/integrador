...
public class CaracteristicaJpaController implements Serializable {
    ...
    public void create(Caracteristica caracteristica) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findCaracteristica(caracteristica.getCodcaracteristica()) != null) {
                throw new PreexistingEntityException("Caracteristica " + caracteristica + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void edit(Caracteristica caracteristica) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                String id = caracteristica.getCodcaracteristica();
    ...
    public void destroy(String id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                caracteristica.getCodcaracteristica();
    ...
    public Caracteristica findCaracteristica(String id) {
        EntityManager em = getEntityManager();
        try {
