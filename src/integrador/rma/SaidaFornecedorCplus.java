...
public class SaidaFornecedorCplus {
   ...
   // Calculoicmsestado calculoIcmsEstado;
    ...
    /**
     * Função que trada de uma saida de cliente
     *
    ...
    /**
     * Função que cria ou edita o controle para devolução de compra
     * @param fornecedor
     * @param saidaProd
     * @param managerCplus
     * @param managerIntegrador 
    ...
    /**
     * Função que relaciona a nota de compra com a devolução para fornecedor
     * @param movSaida
     * @param movEntrada
     * @param managerCplus
     * @param managerIntegrador 
