 ...
 * @author leonardo
 */
public class RenderEstoqueReservaOrcamento extends DefaultTableCellRenderer{
     public RenderEstoqueReservaOrcamento() {
                ...
                for (Produtoestoque estoque : listProdutoestoque) {                                      
                        if ("000000001".equals(estoque.getSetorestoque().getCodsetorestoque())) {
                           // result = preco.getPreco();
                             Number numberValue = (Number)estoque.getReservadoorcamento();
