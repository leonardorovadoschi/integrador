 ...
 * @author leonardo
 */
public class RenderEstoqueDisponivel extends DefaultTableCellRenderer {

    public RenderEstoqueDisponivel() {
        ...
        if ((aValue != null) && (aValue instanceof Collection)) {
            ...
            for (Produtoestoque estoque : listProdutoestoque) {
                if ("000000001".equals(estoque.getSetorestoque().getCodsetorestoque())) {
                    double estoqueAtual = estoque.getEstatu().doubleValue();
                    double reservaOs = estoque.getReservadoos().doubleValue();
                    double reservaOrcamento = estoque.getReservadoorcamento().doubleValue();

                    double numberValue = estoqueAtual - reservaOs - reservaOrcamento;
