 ...
 * @author leo-note
 */
public class ConfTabelaEntradaSerial extends DefaultTableCellRenderer {

    public ConfTabelaEntradaSerial() {
    }
...
//colorir linha impar
        ...
        coluna = table.getColumnModel().getColumnIndex("Entradas");
